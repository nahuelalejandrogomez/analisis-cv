    ...
    <div className="login-container">
      ...
      <div className="login-box">
        <div className="login-header">
          <h1 className="redbee-title">redbee</h1>
          <h2 className="app-title">CV Evaluator</h2>
        </div>

        <div className="login-content">
          <p className="login-subtitle">
            Inicia sesion con tu cuenta de Redbee
          </p>
          ...
          <p className="login-note">
            Solo empleados de Redbee con email @redb.ee
          </p>
        </div>

        <div className="login-footer">
          <p className="footer-text">CV Evaluator by Redbee 2025</p>
        </div>
      </div>
    </div>
  );
